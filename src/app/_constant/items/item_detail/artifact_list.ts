...
export const artifact_list: ItemType[] = [
  ...
  },
  {
    ...
    마력을 주입하여 완성된 의문의 고양이 조각상.
    
    이 의문의 고양이 조각상을 착용 또는 소지품함에 보유하고 있을 경우 다음 혜택이 적용됩니다.
    - '주시자의 신전' 전투를 클리어할 경우 '시공의 편린: 주시자의 신전'을 추가로 1개 더 획득할 수 있습니다.
    `,
    enhancement_options: {
      0: [
        { stat_name: '공격력', stat_value: 1000 },
...

  {
    ...
    마력을 주입하여 완성된 주시자의 웨어울프의 앞발.
    
    이 웨어울프의 앞발을 착용 또는 소지품함에 보유하고 있을 경우 다음 혜택이 적용됩니다.
    - '주시자의 신전' 전투를 클리어할 경우 '시공의 편린: 주시자의 신전'을 추가로 1개 더 획득할 수 있습니다.`,
    enhancement_options: {
      0: [
        { stat_name: '공격력', stat_value: 1000 },
  ...
  },
  {
    ...
    마력을 주입하여 완성된 주시자의 전쟁 여신의 조각상.
    
    이 전쟁 여신의 조각상을 착용 또는 소지품함에 보유하고 있을 경우 다음 혜택이 적용됩니다.
    - '주시자의 신전' 전투를 클리어할 경우 '시공의 편린: 주시자의 신전'을 추가로 1개 더 획득할 수 있습니다.
    `,
    enhancement_options: {
      0: [
  ...
  },
  {
    ...
    마력을 주입하여 완성된 서큐버스의 송곳니.
    
    이 서큐버스의 송곳니를 착용 또는 소지품함에 보유하고 있을 경우 다음 혜택이 적용됩니다.
    - '주시자의 신전' 전투를 클리어할 경우 '시공의 편린: 주시자의 신전'을 추가로 1개 더 획득할 수 있습니다.
    `,
    enhancement_options: {
      0: [
