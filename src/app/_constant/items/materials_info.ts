...
export const materials_info: BasicItemInfoType[] = [
  ...
  {
    item_name: '매끈한 에리우의 결정',
    item_rating: '레어',
    item_crafting: ['금속 갑옷', '재공', '세공'],
    item_description:
      '에리우 다리 방어구, 풍요의 근본을 제작하거나 에리우 다리 방어구를 승급할 때 보조 재료로 사용됩니다.',
  },
  {
...

  {
    ...
    item_description: `모든 능력이 한계에 도달한 무기에 추가 능력을 부여할 수 있는 재료. 장비 연마를 통해 추가 능력을 부여할 수 있습니다. 아직 모든 능력이 한계에 도달하지 않은 장비에는 추가 능력을 부여할 수 없습니다.
      ...
      [주의사항]
      ※ 120레벨 무기 장비의 '파괴력' 연마 재료로 사용할 수 있습니다.
      `,
  },
  {
    item_name: '투쟁의 결정',
    ...
    item_description: `모든 능력이 한계에 도달한 방어구에 추가 능력을 부여할 수 있는 재료. 장비 연마를 통해 추가 능력을 부여할 수 있습니다. 아직 모든 능력이 한계에 도달하지 않은 장비에는 추가 능력을 부여할 수 없습니다.
      ...
      [주의사항]
      ※ 120레벨 방어구 장비의 '파괴력' 연마 재료로 사용할 수 있습니다.
      `,
  },
  {
    item_name: '강화의 룬',
  ...
  },
  {
    ...
    item_rating: '고급',
    item_crafting: ['80 레벨 이상 사용 가능'],
    item_description: `팔찌 장식함을 열면 이하의 구성품 중 하나를 각 확률에 따라 획득한다.
    우클릭으로 열어볼 수 있다.
  ...
  },
  {
    ...
    item_rating: '고급',
    item_crafting: ['재봉'],
    item_description: `스페셜 던전에서 획득한 장인의 섬세한 기운이 담겨진 플라스크.
    
    아바타를 제작할 때 필요한 재료입니다.
    [관련 전문기술: 재봉]`,
  },
  {
    ...
    item_rating: '고급',
    item_crafting: ['금속 갑옷'],
    item_description: `스페셜 던전에서 획득한 장인의 단단한 기운이 담겨진 플라스크.
  ...
  },
  {
    ...
    item_rating: '레어',
    item_crafting: [''],
    item_description: `스페셜 던전에서 획득한 인챈트 주머니.
    개봉 시 인챈트 스크롤을 각 확률에 따라 얻을 수 있습니다.
    - 마우스 우클릭으로 열 수 있습니다.
    - 획득한 인챈트 스크롤은 획득 후 7일이 넘으면 사용할 수 없습니다.`,
  },
  {
    item_name: '자르딘 강철',
    item_rating: '고급',
  ...
  },
  {
    ...
    item_rating: '레어',
    item_crafting: [''],
    item_description: `아르드리 방어구를 제작하거나 복원 재련을 할 때 필요한 재료.
    제작은 전문기술 혹은 콜헨 마을 퍼거스를 통하여 제작할 수 있습니다.
    해당 아이템은 전문기술로 분해가 가능합니다.`,
  },
  {
  ...
  },
  {
    ...
    item_rating: '레어',
    item_crafting: [''],
    item_description: `아르드리 무기를 제작하거나 복원 재련을 할 때 필요한 재료.
    제작은 전문기술 혹은 콜헨 마을 퍼거스를 통하여 제작할 수 있습니다.
    해당 아이템은 전문기술로 분해가 가능합니다.`,
  },
  {
  ...
  },
  {
    ...
    item_rating: '레어',
    item_crafting: ['금속 갑옷', '세공', '제작의뢰'],
    item_description: `아르드리의 힘이 담겨 있다.
    퍼거스와 브린을 통해 다른 아이템으로 제작할 수 있다.`,
  },
  {
  ...
  },
  {
    ...
    item_rating: '레어',
    item_crafting: ['세공', '제작의뢰'],
    item_description: `나베리우스의 힘이 담겨 있다.
    브린을 통해 다른 아이템으로 제작할 수 있다.`,
  },
  {
    item_name: '밀레드의 봉인된 힘',
    item_rating: '레어',
    item_crafting: ['세공', '제작의뢰'],
    item_description: `밀레드의 힘이 담겨 있다.
    브린을 통해 다른 아이템으로 제작할 수 있다.`,
  },
  {
    ...
    item_rating: '레어',
    item_crafting: ['세공', '제작의뢰'],
    item_description: `카사르의 힘이 담겨 있다.
    브린을 통해 다른 아이템으로 제작할 수 있다.`,
  },
  {
    item_name: '에녹의 봉인된 힘',
  ...
  },
  {
    ...
    item_rating: '레어',
    item_crafting: ['세공', '제작의뢰'],
    item_description: `에메트의 힘이 담겨 있다.
    브린을 통해 다른 아이템으로 제작할 수 있다.`,
  },
  {
    ...
    item_rating: '레어',
    item_crafting: ['세공', '제작의뢰'],
    item_description: `브레스의 힘이 담겨 있다.
    브린을 통해 다른 아이템으로 제작할 수 있다.`,
  },
  {
    ...
    item_rating: '레어',
    item_crafting: ['세공', '제작의뢰'],
    item_description: `야르니르의 힘이 담겨 있다.
    브린을 통해 다른 아이템으로 제작할 수 있다.`,
  },
  {
  ...
  },
  {
    ...
    item_rating: '레어',
    item_crafting: [''],
    item_description: `결사대 전투를 완수하고 획득한 상자.
    굳은 신념을 지닌 자들만이 획득 할 수 잇다고 전해진다.
    개봉 시 각 확률에 따라 구성품 중 1종을 획득할 수 있습니다.

    ■ 구성품
    - 각성의 돌: SP소모 감소 80 1개
    - 각성의 돌: 스태미나 소모 감소 6 1개
    - 각성의 돌: 대미지 증가 12% 1개
    - 각성의 돌: 부분 파괴 대미지 증가 12% 1개
    - 정령이 깃든 천뭉치 5개
    - 정령이 깃든 장식 파편 5개
    - 정령이 깃든 무기 파편 5개
    - 정령이 깃든 갑옷 파편 5개
  ...
  },
  {
    ...
    item_crafting: [''],
    item_description: `결사대 전투를 완수하고 획득한 상자.
    굳은 결의를 지닌 자들만이 획득 할 수 잇다고 전해진다.
    개봉 시 각 확률에 따라 구성품 중 1종을 획득할 수 있습니다.
  ...
  },
  {
    ...
    item_crafting: [''],
    item_description: `결사대 전투를 완수하고 획득한 상자.
    강림한 신에 맞서 싸운 자들만이 획득할 수 있다고 전해진다.
    개봉 시 각 확률에 따라 구성품 중 1종을 획득할 수 있습니다.
  ...
  },
  {
    ...
    item_rating: '레어',
    item_crafting: [''],
    item_description: `시공간 왜곡: 찬탈자의 성채를 완수하여 획득한 상자.`,
  },
  {
    item_name: '시공의 상자: 몰락한 기사의 전당',
    item_rating: '레어',
    item_crafting: [''],
    item_description: `시공간 왜곡: 몰락한 기사의 전당을 완수하여 획득한 상자.`,
  },
  {
  ...
  },
  {
    ...
    item_rating: '고급',
    item_crafting: [''],
    item_description: `해당 전문기술의 장인 등급 전문기술을 보유하고 있는 캐릭터만 사용할 수 있으며,
    사용 시 해당하는 아바타 제작 레시피를 습득할 수 있습니다.
    레시피를 한 번 사용할 때마다 3회의 제작 횟수가 충전되며, 레시피 별 충전 횟수는 계정 단위로 저장됩니다.
    아바타는 세트로 제작되며, 드레스 포인트는 10점입니다.`,
  },
  {
  ...
  },
  {
    ...
    item_rating: '고급',
    item_crafting: [''],
    item_description: `관련된 제작 방법이 적혀있는 레시피 스크롤.
    우클릭으로 사용 시 전문기술에 맞는 제작 레시피를 습득할 수 있습니다.`,
  },
  {
  ...
  },
  {
    ...
    item_description: `인챈트 또는 아이템 연마로 추가 능력치를 개방한 아이템에서 관련된 소재를 추출할 수 있는 룬입니다.
      ...
      - 이 경우 115레벨 이하 아이템은 9단계 이상 강화 및 인챈트 또는 파괴력 능력치가 개방되어 있어야 합니다. 120레벨 이상 아이템은 인챈트 또는 파괴력 능력치가 개방되어 있어야 합니다.
      - 연마된 아이템 추출 시 추출의 룬을 사용하면 아이템의 인챈트와 파괴력 연마 재료를 돌려받습니다.
      - 돌려받는 인챈트는 100% 성공 인챈트로 돌려받으며, 사용 기한 제한이 없습니다.

      ※ 주의 사항
      - 돌려받은 인챈트는 귀속되며, 파괴력 연마 재료는 ID내 1회만 거래 가능합니다.
      - 단, 추출 시 획득한 봉인의 힘: 파편, 전승의 힘: 파편은 거래소 거래가 가능합니다.
      
      ■ 아이템 강화 시 사용
      - 인챈트 또는 파괴력 등의 추가 능력치가 개방된 아이템을 9단계 이상 강화할 때, 강화의 룬 처럼 재료로 사용할 수 있습니다.
      - 강화 시도 시, 추출의 룬을 사용하면 강화 실패로 아이템이 파괴될 때 인챈트와 파괴력 연마 재료를 돌려받습니다.
      - 강화 성공 시에는 소모되지 않습니다.
      - 돌려받는 인챈트는 100% 성공 인챈트로 돌려받으며, 사용기한 제한이 없습니다.

      ※ 주의 사항
      - 돌려받는 인챈트는 귀속되며, 파괴력 연마 재료는 ID 내 1회만 거래가 가능합니다.
      - 단, 추출 시 획득한 봉인의 힘:파편, 전승의 힘:파편은 거래소 거래가 가능합니다.
  ...
  },
  {
    ...
    ※ 13단계 이상 강화된 장비에만 파괴력을 진행할 수 있습니다.`,
  },
  {
  ...
  },
  {
    ...
    [주의사항]
    ※ 110 ~ 115레벨 무기 장비의 '파괴력' 재료로 사용할 수 있습니다.
    ※ 13단계 이상 강화된 장비에만 파괴력을 진행할 수 있습니다.`,
  },
  {
    ...
    [주의사항]
    ※ 110 ~ 115레벨 방어구 장비의 '파괴력' 재료로 사용할 수 있습니다.
    ※ 13단계 이상 강화된 장비에만 파괴력을 진행할 수 있습니다.`,
  },
  {
    item_name: '뉴에라의 옷감',
