...
export const raidList: RaidListType[] = [
...

  {
    ...
    monsters: [
      ...
      // {
      //   name: "요르드라 (11월21일 업데이트)",
      //   entry: [
      //     { stat_name: "이름", stat_value: "" },
      //     { stat_name: "레벨", stat_value: "" },
      //     { stat_name: "공격력", stat_value: "" },
      //     { stat_name: "크리티컬", stat_value: "" },
      //     { stat_name: "해제", stat_value: "" },
      //     { stat_name: "추가피해", stat_value: "" },
      //     { stat_name: "방어력", stat_value: "" },
      //     { stat_name: "밸런스", stat_value: "" },
      //     { stat_name: "대항력", stat_value: "" },
      //   ],
      //   limit: [
      //     { stat_name: "이름", stat_value: "" },
      //     { stat_name: "레벨", stat_value: "" },
      //     { stat_name: "공격력", stat_value: "" },
      //     { stat_name: "크리티컬", stat_value: "" },
      //     { stat_name: "크리티컬 저항", stat_value: "" },
      //     { stat_name: "대항력 저항", stat_value: "" },
      //     { stat_name: "밸런스 저항", stat_value: "" },
      //   ],
      //   drop_items: [],
